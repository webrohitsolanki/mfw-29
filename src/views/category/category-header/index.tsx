...
export const CategoryHeader = (props: Props) => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-4 mb-4 text-gray-950 text-sm p-1 lg:mt-0 mt-5 border border-t-[#E987B4] border-b-[#E987B4] border-l-0 border-r-0 w-full">
        {/* <div className={`flex flex-col gap-4 mb-4 text-gray-950 text-sm ${Style.category_header_mobile} ${Style.list_main_content}`}> */}
        <div className='flex justify-between items-center'>
          ...
          <div>
            <div className="hidden lg:flex gap-5 ml-auto mr-7 py-2 border border-l-0 border-t-0 border-b-0 pr-[3.25rem] border-r-[#E987B4]">
              {/* <div className={`hidden lg:flex gap-5 ml-auto mr-7 py-2 border border-gray-100 ${Style.dropdown_list_sorter}`}> */}
          ...
          <div className='flex items-center'>
            <Button
              ...
              // className={`relative ${Style.filter_mobile} gap-5 border-gray-100 flex border-0 items-center text-left bg-white text-primary-100 w-40 lg:hidden lg:mr-0`}
            ...
            <div className='flex items-center flex-col lg:flex-row '>
              <span className='w-full text-left flex lg:flex-row items-center flex-col'>
                ...
                {/* <h3 className={`uppercase text-base ${Style.sort_by_mobile} text-left w-full font-medium`}>Sort by :</h3> */}

                <Select
                  options={sortOptions}
                  value={sortOptions.find(({ is_selected }) => is_selected).value}
                  data-testid="list-sorter"
                  // className={`${Style.dropdown_list_grid}`}
