...
export const ProductItem = (props: Props) => {
  ...
  return (
    <Wrapper>
      <div
        className="text-sm text-left relative flex flex-col h-full "
      ...
      >
        ...
        <div
          className="relative mb-3 border-pink-400 text-center aspect-square w-auto overflow-hidden"
          style={{ aspectRatio: 1 }}
        >
          <Link href={absolute_url} onClick={() => pushProductViewed(product)}>
            {image_url ? (
              <Image
                ...
                loading="lazy"
                src={image_url}
                className="w-auto h-full product_single_image aspect-square"
                alt={product_name}
                width={100}
                height={100}
                unoptimized
        ...
        <div title={product_name.length > 20 ? product_name : ''}>
          <Link
            href={absolute_url}
            // className={`listing_text product_title lg:text-base ${
            //   product_name.length > 20 ? 'ellipsis' : ''
            // }`}
            className={`listing_text product_title pe-[2px] capitalize lg:text-base  whitespace-nowrap overflow-hidden w-full text-ellipsis inline-block
              leading-none`}
