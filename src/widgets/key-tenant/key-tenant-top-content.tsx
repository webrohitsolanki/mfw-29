...
import ENTRYTANENTContent from '@theme/views/tanent/index-top';
import TANENTTOPContent from '@theme/views/tanent/index-top';
...
export default async function HomeHeroSlider() {
    const data = await getWidgetData<HomeLeapType>({
        slug: 'key-tenant-prices'
    });
    return <TANENTTOPContent data={data} />;
}
